...
export default function SearchBar() {
    ...
    return (
        <div className="relative">
            <div id="searchBar" className="w-full mt-12 flex justify-center">
                <div className="text-gray-100 flex items-center w-[calc(100%-24px)]">
                    <div className={open ?
                        ...
                        :
                        ("ring-2 ring-white/10 text-gray-100 focus-within:border-2 focus-within:border-white relative flex items-center w-full border-none h-[42px] rounded-lg bg-neutral-700")}>
