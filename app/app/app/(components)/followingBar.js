...
export default function FollowingBar() {
    ...
    return (
        <div className="ml-4 my-5 flex gap-[10px] overflow-x-scroll">
            <div className="flex justify-start flex-col items-center">
                ...
                <div className="flex justify-center">
                    <p className="font-medium text-[13px] w-[66px] overflow-hidden text-center mt-1 whitespace-nowrap text-ellipsis text-white">Rachel</p>
                </div>
            </div>
            <div className="flex justify-center flex-col items-center">
                ...
                <div className="flex justify-center flex-col">
                    <p className="font-medium text-[13px] w-[66px] overflow-hidden text-center mt-.5 whitespace-nowrap text-ellipsis text-white">Colin Atkinson</p>
                    <p className="font-medium text-[11px] w-[66px] overflow-hidden text-center -mt-1 whitespace-nowrap text-ellipsis text-neutral-500">colinatkinson</p>
                </div>
            </div>
        </div>
    );
