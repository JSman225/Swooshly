export default function Temp({ visible, onClose }) {
    return (
      <div className={`fixed top-0 left-0 max-w-md w-full h-screen z-[100] backdrop-blur-lg bg-[#111111] bg-opacity-80 flex-col flex items-start justify-end pl-6 pb-6 transition-all ${visible ? 'opacity-100 transform translate-x-0' : 'opacity-0 transform translate-x-full'}`}>
        {visible && (
          <>
