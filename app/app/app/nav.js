...
export default function Nav() {
    ...
    return (
        <div className={currentPage === "/app/swoosh" ? "bg-slate-100/10 flex justify-center h-[4.5rem] ring-2 ring-slate-100/30 shadow-2xl w-[calc(100%-24px)] mx-auto inset-x-0 fixed bottom-6 z-50 rounded-full" : "bg-[#1e1e1e] flex justify-center h-24 w-full fixed bottom-0 max-w-md z-50 rounded-top-mega"} id="nav-bar">
