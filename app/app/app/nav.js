...
export default function Nav() {
    ...
    return (
        <div className={currentPage === "/app/swoosh" ? "bg-slate-100/10 flex justify-center h-20 w-[calc(100%-32px)] mx-auto inset-x-0 fixed bottom-4 z-50 rounded-full" : "bg-[#1e1e1e] flex justify-center h-24 w-full fixed bottom-0 max-w-md z-50 rounded-top-mega"} id="nav-bar">
